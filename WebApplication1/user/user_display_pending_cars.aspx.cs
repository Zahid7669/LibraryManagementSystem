...
{
    public partial class user_display_pending_cars: System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from booking where username = '" + Session["student"] + "' and status='pending'";
            cmd.ExecuteNonQuery();
