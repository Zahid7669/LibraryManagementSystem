...
namespace WebApplication1.librarian
{
    public partial class issue_books : System.Web.UI.Page
    {
        ...
        {
            // this is for check books selected or not
            ...
            // this is for checking student have books or not
            ...
            cmd3.CommandText = "insert into issue_books values('"+enrno.SelectedItem.ToString()+"','"+ enrno.SelectedItem.ToString() + "','"+ books_issue_date.ToString() + "','"+approx_return_date.ToString()+"','"+username.ToString()+"','no','no')";
            ...
            Response.Write("<script>alert('Books issues succesfully'); window.location.href=window.location.href;</script>");
